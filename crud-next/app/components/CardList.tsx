          ...
          <div className="card bg-base-100 w-80 mx-4 mb-4" key={blog.id}>
            <div className="card-body">
              <Link href={`/${blog.id}`}>
                <figure>
                  <img
                    src="https://plus.unsplash.com/premium_photo-1665329006985-04f95dd59402?q=80&w=2071&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                    alt="shoes"
